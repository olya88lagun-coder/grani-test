...
> **Статус: выполнен 2026-09-21.** 381 тест + 6 сквозных (Playwright, с работающим воркером); покрытие: строки 92,8%, выражения 91,3%, функции 89,3%, ветви 89,0%. Сборки сайта и воркера без предупреждений. Уведомления проверены в режиме dry run; настоящие — после выкладки (план 6). `VK_GROUP_ID` ещё не получен.
